...
class App:
    ...
    def quit(self, ewent: tkinter.Event) -> None:
        self.window.destroy()
    ...
    def make_widgets(self) -> None:
        ...
        self.buttons_frame['bg'] = 'DeepSkyBlue4'
        self.buttons_frame['padx'] = '50'
        self.buttons_frame['pady'] = '50'
    ...
    def position_widgets(self) -> None:
        ...
        self.window.title('моя игра')
        self.window['bg'] = 'DodgerBlue3'
        self.questions_frame.pack(expand=True)
        self.questions_frame['bg'] = 'cyan3'
        ...
        self.anwer_button_1.pack(side='left')
        self.anwer_button_2.pack(side='left')
        self.anwer_button_3.pack(side='left')
        self.anwer_button_4.pack(side='left')
    ...
    def show_result(self) -> None:
        ...
        tkinter.Label(
            self.results_frame, text=f'Всего вопросов: {len(questions)}'
        ).pack()
        tkinter.Label(
            self.results_frame, text=f'Правильных ответов: {self.right_anwers}'
        ).pack()
        tkinter.Label(
            self.results_frame, text=f'Ошибок: {self.wrong_anwers}'
        ).pack()
        tkinter.Button(
            self.results_frame, text='Начать заного', command=self.start
        ).pack()
